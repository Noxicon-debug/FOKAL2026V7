...
export default function Footer() {
  return <footer className="fokal-footer">
    <div className="footer-grid">
      <div><img className="footer-logo" src={logoUrl} alt="Fokal"/><p>A Papua New Guinea based media production, marketing and events company delivering creative solutions that connect brands with people and make an impact that lasts.</p><div className="socials"><Facebook/><Instagram/><Youtube/><Linkedin/><TikTokIcon/></div></div>
      ...
      <div><h4>CONTACT US</h4><span><Phone/> +675 7295 5054 / 8478 2028</span><span><Mail/> info@fokalltd.com</span><span><MapPin/> Port Moresby, NCD<br/>Papua New Guinea</span></div>
    </div>
